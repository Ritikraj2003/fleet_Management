...
{
    /// <inheritdoc />
    public partial class InitialInt : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOwnVehicle = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleTypeRequired = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketplaceRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    BuyerTenantId = table.Column<int>(type: "integer", nullable: false),
                    SellerTenantId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "MarketplaceVehicleAvailabilities",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketplaceVehicleAvailabilities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleMaintenances_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EntityFiles_Files_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MarketplaceRequestId = table.Column<int>(type: "integer", nullable: false),
                    OfferPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    QuantityOffered = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MarketplaceOffers_MarketplaceRequests_MarketplaceRequestId",
                        column: x => x.MarketplaceRequestId,
                        principalTable: "MarketplaceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerDrivers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartnerDrivers_Partners_PartnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerVehicles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartnerVehicles_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorPayments_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "MarketplaceAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MarketplaceOfferId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketplaceAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarketplaceAssignments_MarketplaceOffers_MarketplaceOfferId",
                        column: x => x.MarketplaceOfferId,
                        principalTable: "MarketplaceOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarId = table.Column<int>(type: "integer", nullable: true),
                    DriverId = table.Column<int>(type: "integer", nullable: true),
                    PartnerVehicleId = table.Column<int>(type: "integer", nullable: true),
                    PartnerDriverId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingVehicles_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingVehicles_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookingVehicles_PartnerDrivers_PartnerDriverId",
                        column: x => x.PartnerDriverId,
                        principalTable: "PartnerDrivers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookingVehicles_PartnerVehicles_PartnerVehicleId",
                        column: x => x.PartnerVehicleId,
                        principalTable: "PartnerVehicles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriverAttendances_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriverVehicleAssignments_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    BookingVehicleId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RideTrackings_BookingVehicles_BookingVehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingVehicles_BookingId",
                table: "BookingVehicles",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingVehicles_CarId",
                table: "BookingVehicles",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingVehicles_PartnerDriverId",
                table: "BookingVehicles",
                column: "PartnerDriverId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingVehicles_PartnerVehicleId",
                table: "BookingVehicles",
                column: "PartnerVehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_DriverAttendances_DriverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverVehicleAssignments_CarId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketplaceAssignments_MarketplaceOfferId",
                table: "MarketplaceAssignments",
                column: "MarketplaceOfferId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketplaceOffers_MarketplaceRequestId",
                table: "MarketplaceOffers",
                column: "MarketplaceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerDrivers_PartnerId",
                table: "PartnerDrivers",
                column: "PartnerId");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerVehicles_PartnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RideTrackings_BookingVehicleId",
                table: "RideTrackings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleMaintenances_CarId",
                table: "VehicleMaintenances",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorPayments_PartnerId",
